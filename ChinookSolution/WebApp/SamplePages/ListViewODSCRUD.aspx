...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <blockquote>
        This page will demonstrate a CRUD process using the ListView control and only
        ODS Datasources. Web control Validation will be demonstrated under the EditTemplate
        and InsertTemplate.
    </blockquote>
    <br />
